       ...
       <div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
        <div class="card">
          ...
          <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
            <div class="card-body">
                <form  wire:submit.prevent="updateSeoData">
                                      ...
                                      <div class="image_area">
                                        <form method="post">
                                          <label for="upload_og_img" class="cabinet uploadStyle ">  
                                            <img src="{{(isset($this->og_image))? asset('storage/meta/'.$this->og_image):asset('no_image.jpg')}}" id="uploaded_job_img1"  class="wd-- img-responsive img-fluid rounded" wire:ignore  style="max-height: auto ; width:200px;"/> 
        ...
        $(document).ready(function(){
          ...
          $("#crop").click(function(){
              ...
              canvas.toBlob(function(blob) {
                ...
                Livewire.emit('updateogImg',  base64data)
                $modal.modal('hide');
