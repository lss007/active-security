<div>
    ...
    <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5>Update  Home  Clients </h5>
      
        </div><!-- sl-page-title -->

    <div class="card pd-20 pd-sm-40">
        <h6 class="card-body-title"> Update Client  
                ...
                {{-- <div class="col-lg-12">
                  ...
                  <div class="col-lg-12">
                   <div class="form-group">
                     ...
                     <input type="file" class="form-control"   wire:model="clientIng"  >
                   @error('clientIng')<span class="text-danger"> {{$message}}</span>  @enderror  
                   </div>
