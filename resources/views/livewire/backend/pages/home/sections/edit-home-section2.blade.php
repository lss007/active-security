<div>
        ...
        <form  wire:submit.prevent="updateHomeSection2">
            <div class="form-layout">
              ...
              <div class="col-lg-12">
                ...
                <div class="row croper_sec">
                    ...
                    <div class="col-md-12">
                      <div class="image_area">
                        <form method="post">
                          <label for="editupload_image2" class="cabinet uploadStyle ">  
                            <img src="{{(isset($this->Image)) 
                              ? asset('storage/Home-section/'.$this->Image):asset('no_image.jpg')}}" id="uploaded_image"  class="wd-- img-responsive img-fluid rounded" wire:ignore  width="50%" class="wd-- img-responsive img-fluid rounded" wire:ignore   style="max-height: auto ; width:200px;"/> 
                            <span>Upload Image</span>                          
                            <input type="file" name="image" class="image" id="editupload_image2"  />
                          </label>
                        </form>
                      </div>
                    </div>
                ...
                @error('getHomeSecImg2')<span class="text-danger"> {{$message}}</span>  @enderror  
    ...
    <script>
      ...
      $(document).ready(function(){
        ...
        var $modal = $('#modal');
        var image = document.getElementById('editHomeSecImg2');
        var cropper;
      
        //$("body").on("change", ".image", function(e){
        $('#editupload_image2').change(function(event){
        ...
        $("#crop").click(function(){
            ...
            canvas.toBlob(function(blob) {
              ...
              Livewire.emit('editHomeSecImg2',  base64data)
