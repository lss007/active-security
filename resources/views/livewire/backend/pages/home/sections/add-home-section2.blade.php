<div>
    ...
    <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5> {{__('dashboard.Home section two')}}</h5>
               ...
               <div class="row mg-b-25">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    onchange='Livewire.emit("selectSection2", this.value)'
                    >
           ...
           @endif
              ...
              <div class="col-lg-4">
                  <label class="form-control-label">Image For Desktop:<span class="tx-danger">*</span></label><br>
                    <div class="row croper_sec">
                        ...
                        @error('addHomeSecImg')<span class="text-danger"> {{$message}}</span>  @enderror  
                    ...
                    <div class="col-md-12">
                      <div class="image_area">
                        <form method="post">
                          ...
                          <label for="upload_sec_img2" class="cabinet uploadStyle ">  
                            <img src="" id="uploaded_job_img2"  class="wd-- img-responsive img-fluid rounded" wire:ignore  style="max-height: auto ; width:100px;"/> 
                            <span>Upload Image</span>                          
                            <input type="file" name="image" class="image" id="upload_sec_img2"  />
                          </label>
                        </form>
                      </div>
                    </div>
                    @error('addHomeSecImg2')<span class="text-danger"> {{$message}}</span>  @enderror  
                

                    {{-- start large model  --}}
                    <div id="secmodal2" class="modal fade" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
            ...
            {{-- For mobile  --}}
              <div class="col-lg-4">
                      ...
                      <div class="image_area">
                        <form method="post">
                          <label for="upload_sec_img3" class="cabinet uploadStyle ">  
                            <img src="" id="uploaded_sec2_img3"  class="wd-- img-responsive img-fluid rounded" wire:ignore  style="max-height: auto ; width:100px;"/> 
                            <span>Upload Image</span>                          
                ...
                @error('addHomeSecImg3')<span class="text-danger"> {{$message}}</span>  @enderror  
    ...
    <script>
      $(document).ready(function(){
        var $modal = $('#modal');
        var image = document.getElementById('homeSectionImg2');
        var cropper;
        ...
        $("#crop").click(function(){
            ...
            canvas.toBlob(function(blob) {
                var reader = new FileReader();
                 ...
                 Livewire.emit('getSection2Img',  base64data)
                 $modal.modal('hide');
      ...
      <script>
        $(document).ready(function(){
          var $modal = $('#secmodal2');
          var image = document.getElementById('homesec2img2');
          var cropper;
          $('#upload_sec_img2').change(function(event){
              var files = event.target.files;
              var done = function (url) {
                  image.src = url;
                  $modal.modal('show');
          ...
          $("#crop2").click(function(){
              ...
              canvas.toBlob(function(blob) {
                  var reader = new FileReader();
                    ...
                    reader.onloadend = function() {
                      var base64data = reader.result;  
                Livewire.emit('getSection2Img2',  base64data)
                $modal.modal('hide');
          ...
          $("#crop3").click(function(){
              ...
              canvas.toBlob(function(blob) {
                  var reader = new FileReader();
                    ...
                    reader.onloadend = function() {
                      var base64data = reader.result;  
                Livewire.emit('getSection2Img3',  base64data)
                $modal.modal('hide');
