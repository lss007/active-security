<div>
    ...
    <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5>{{__('dashboard.Update Company Profile section')}}</h5>
              ...
              <div class="card-header" role="tab" id="headingOne">
                <h6 class="mg-b-0">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="tx-gray-800 transition">
                    {{__('dashboard.Update Company Profile section')}}
                  </a>
                </h6>
              </div><!-- card-header -->
                              ...
                              <div class="row croper_sec">
                                <div class="col-md-12">
                                  <div class="image_area">
                                    <form method="post">
                                      <label for="update_company_img1" class="cabinet uploadStyle ">  
                                        <img src="{{(isset($this->profile_img))? asset('storage/company-profile/'.$this->profile_img):asset('no_image.jpg')}}" id="store_company_img1"  class="wd-- img-responsive img-fluid rounded" wire:ignore  style="max-height: auto ; width:100px;"/> 
                                        <span>Upload Image</span>                          
                                        <input type="file" name="image" class="image" id="update_company_img1"  />
                                      </label>
                                    </form>
                                  </div>
                                </div>
                                    ...
                                    <div class="modal-content tx-size-sm">
                                      ...
                                      <div class="modal-body pd-20">
                                        <div class="img-container">
                                          <div class="row">
                                              <div class="col-md-8">
                                                  <img src="" id="edit_company_image1" />
                                              </div>
                            ...
                            <label class="form-control-label">  Image For Tablet:   <span class="tx-danger"> *</span></label><br>
                              <div class="row croper_sec">
                                <div class="col-md-12">
                                  <div class="image_area">
                                    <form method="post">
                                      <label for="update_company_img2" class="cabinet uploadStyle ">  
                                        <img src="{{(isset($this->tablet_banner))? asset('storage/company-profile/'.$this->tablet_banner):asset('no_image.jpg')}}" id="store_company_img2"  class="wd-- img-responsive img-fluid rounded" wire:ignore  style="max-height: auto ; width:100px;"/> 
                                        <span>Upload Image</span>                          
                                        <input type="file" name="image" class="image" id="update_company_img2"  />
                                      </label>
                                    </form>
                                  </div>
                                </div>
                                    ...
                                    <div class="modal-content tx-size-sm">
                                      ...
                                      <div class="modal-body pd-20">
                                        <div class="img-container">
                                          <div class="row">
                                              <div class="col-md-8">
                                                  <img src="" id="edit_company_image2" />
                                              </div>
                                              <div class="col-md-4 pointerNone">
                                                  <div class="preview"></div>
                                              </div>
                            ...
                            <label class="form-control-label">  Image For Mobile:   <span class="tx-danger"> *</span></label><br>
                              <div class="row croper_sec">
                                <div class="col-md-12">
                                  <div class="image_area">
                                    <form method="post">
                                      <label for="update_company_img3" class="cabinet uploadStyle ">  
                                        <img src="{{(isset($this->mobile_banner))? asset('storage/company-profile/'.$this->mobile_banner):asset('no_image.jpg')}}" id="store_company_img3"  class="wd-- img-responsive img-fluid rounded" wire:ignore  style="max-height: auto ; width:100px;"/> 
                                        <span>Upload Image</span>                          
                                        <input type="file" name="image" class="image" id="update_company_img3"  />
                                      </label>
                                    </form>
                                  </div>
                                </div>
                                    ...
                                    <div class="modal-content tx-size-sm">
                                      ...
                                      <div class="modal-body pd-20">
                                        <div class="img-container">
                                          <div class="row">
                                              <div class="col-md-8">
                                                  <img src="" id="edit_company_image3" />
                                              </div>
                                              <div class="col-md-4 pointerNone">
                                                  <div class="preview"></div>
                                              </div>
    ...
    <script>
      $(document).ready(function(){
        var $modal = $('#modal1');
        var image = document.getElementById('edit_company_image1');
        var cropper;
        $('#update_company_img1').change(function(event){
        ...
        $("#crop").click(function(){
            ...
            canvas.toBlob(function(blob) {
              ...
              Livewire.emit('updateCompanyImg',  base64data)
              $modal.modal('hide');
              $('#store_company_img1').attr('src', base64data);
                  }
            });
          });
      });
    ...
    <script>
      $(document).ready(function(){
        var $modal = $('#modal2');
        var image = document.getElementById('edit_company_image2');
        var cropper;
        $('#update_company_img2').change(function(event){
            var files = event.target.files;
            var done = function (url) {
                image.src = url;
                $modal.modal('show');
        ...
        $("#crop2").click(function(){
            ...
            canvas.toBlob(function(blob) {
                ...
                var reader = new FileReader();
                 ...
                 reader.onloadend = function() {
                    var base64data = reader.result;  
              Livewire.emit('updateCompanyImg2',  base64data)
              $modal.modal('hide');
              $('#store_company_img2').attr('src', base64data);
                 }
            });
          });
      });
    ...
    <script>
      $(document).ready(function(){
        var $modal = $('#modal3');
        var image = document.getElementById('edit_company_image3');
        var cropper;
        $('#update_company_img3').change(function(event){
            var files = event.target.files;
            var done = function (url) {
                image.src = url;
                $modal.modal('show');
        ...
        $("#crop3").click(function(){
            ...
            canvas.toBlob(function(blob) {
                ...
                var reader = new FileReader();
                 ...
                 reader.onloadend = function() {
                    var base64data = reader.result;  
              Livewire.emit('updateCompanyImg3',  base64data)
              $modal.modal('hide');
              $('#store_company_img3').attr('src', base64data);
                 }
            });
          });
      });
