<div>
    ...
    <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5>{{__('dashboard.Add Company Section')}} </h5>
          ...
          <div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
            <div class="card">
              ...
              <div class="card-header" role="tab" id="headingOne">
                <h6 class="mg-b-0">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="tx-gray-800 transition">
                    {{__('dashboard.Add Company Section')}}
                  </a>
                </h6>
              </div><!-- card-header -->
              ...
              <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                <div class="card-body">
                  <form  wire:submit.prevent="storecompanySection">
                      ...
                      <div class="row mg-b-25">
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" wire:model="title"  placeholder="Title 1">
                        ...
                        <div class="col-lg-12">
                           <div class="form-group mg-b-10-force">
                             ...
                             <textarea class="form-control"   wire:model="para1" placeholder="Section paragraph 1"></textarea>
                         ...
                         <div class="col-lg-12">
                           <div class="form-group mg-b-10-force">
                             ...
                             <textarea class="form-control"   wire:model="para2" placeholder="Section paragraph 2"></textarea>
                         ...
                         <div class="col-lg-12">
                           <div class="form-group mg-b-10-force">
                             ...
                             <textarea class="form-control"   wire:model="para3" placeholder="Section paragraph 3"></textarea>
                         ...
                         <div class="col-lg-12">
                          <div class="form-group mg-b-10-force">
                            ...
                            <textarea class="form-control"   wire:model="para4" placeholder="Section paragraph 4"></textarea>
                        ...
                        <div class="col-lg-12">
                          <div class="form-group mg-b-10-force">
                            <label class="form-control-label">Section Paragraph 4: <span class="tx-danger">*</span></label>
                            <textarea rows="5"  class="form-control"   wire:model="para4" placeholder="Section paragraph 4"></textarea>
                            @error('para4')<span class="text-danger"> {{$message}}</span>  @enderror  
