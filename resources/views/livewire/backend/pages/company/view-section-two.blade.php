<div>
  ...
  <div class="sl-pagebody">
      <div class="sl-page-title">
        <h5>{{__('dashboard.Manage Company profile section')}}  
          <span class="float-right"> Total :{{isset($getSectionData) ?count($getSectionData) : "NA" }}</span>
        </h5>
       
      </div><!-- sl-page-title -->
      <div class="card pd-20 pd-sm-40">
        <h6 class="card-body-title">      
          <a href="{{route('addCompanySections2')}}"><button class="btn btn-teal active mg-b-10">{{__('dashboard.Add Section')}}</button> </a>
