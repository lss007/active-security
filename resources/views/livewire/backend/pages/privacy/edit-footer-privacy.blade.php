<div>
    ...
    <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5>{{__('dashboard.Update Privacy Text')}}</h5>
          ...
          <div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
            <div class="card">
              ...
              <div class="card-header" role="tab" id="headingOne">
                <h6 class="mg-b-0">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="tx-gray-800 transition">
                    {{__('dashboard.Update Privacy Text')}}
                  </a>
                </h6>
              </div><!-- card-header -->
              ...
              <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                <div class="card-body">
                  <form  wire:submit.prevent="updatePrivacyText">
                    <div class="form-layout">
                      <div class="row mg-b-25">
                         ...
                         <div class="col-lg-12">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group mg-b-10-force">
                              <label class="form-control-label">Privacy Paragraph 1: <span class="tx-danger">*</span></label>
                              <textarea class="form-control" rows="5"   wire:model="para1" placeholder="Privacy paragraph 1"></textarea>
                         ...
                         <div class="col-lg-12">
                           <div class="form-group mg-b-10-force">
                             <label class="form-control-label">Privacy Paragraph 2: <span class="tx-danger">*</span></label>
                             <textarea class="form-control" rows="5"   wire:model="para2" placeholder="Privacy paragraph 2"></textarea>
                         ...
                         <div class="col-lg-12">
                          <div class="form-group mg-b-10-force">
                            <label class="form-control-label">Privacy Paragraph 3: <span class="tx-danger">*</span></label>
                            <textarea class="form-control" rows="5"   wire:model="para3" placeholder="Privacy paragraph 3"></textarea>
                        ...
                        <div class="col-lg-12">
                          <div class="form-group mg-b-10-force">
                            <label class="form-control-label">Privacy Paragraph 4: <span class="tx-danger">*</span></label>
                            <textarea class="form-control" rows="5"   wire:model="para4" placeholder="Privacy paragraph 4"></textarea>
